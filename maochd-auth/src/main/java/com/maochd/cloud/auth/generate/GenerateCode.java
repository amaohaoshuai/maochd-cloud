package com.maochd.cloud.auth.generate;
...
public class GenerateCode {
    ...
    public static String DB_URL = "jdbc:mysql://192.168.119.129:3306/auth?useUnicode=true" +
    ...
    public static String MODULE_NAME = "/maochd-auth";

    public static String AUTHOR = "maochd";

    public static String PARENT = "com.maochd.cloud.auth";
