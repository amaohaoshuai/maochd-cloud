package com.maochd.cloud.goods.generate;
...
public class GenerateCode {
    ...
    public static String DB_URL = "jdbc:mysql://10.10.3.81:3306/goods?useUnicode=true" +
    ...
    public static String MODULE_NAME = "/maochd-goods";

    public static String AUTHOR = "maochd";

    public static String PARENT = "com.maochd.cloud.goods";
