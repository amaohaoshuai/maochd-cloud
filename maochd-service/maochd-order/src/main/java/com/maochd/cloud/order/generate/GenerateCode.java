package com.maochd.cloud.order.generate;
...
public class GenerateCode {
    ...
    public static String DB_URL = "jdbc:mysql://192.168.119.129:3306/order?useUnicode=true" +
    ...
    public static String MODULE_NAME = "/maochd-order";

    public static String AUTHOR = "maochd";

    public static String PARENT = "com.maochd.cloud.order";
