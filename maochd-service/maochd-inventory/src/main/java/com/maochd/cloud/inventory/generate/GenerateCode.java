package com.maochd.cloud.inventory.generate;
...
public class GenerateCode {
    ...
    public static String DB_URL = "jdbc:mysql://192.168.119.131:3306/inventory?useUnicode=true" +
    ...
    public static String MODULE_NAME = "/maochd-inventory";

    public static String AUTHOR = "maochd";

    public static String PARENT = "com.maochd.cloud.inventory";
